...
| 3 | Nómina mensual compleja | Payroll | sí | sí | sí | PDF | parcial | PARTIAL | PENDING_VALIDATION | no | no | payslip + render model | objetivo PASS tras snapshot determinista |
| 3a | Horas extras | Payroll · Incidencias | sí | sí | sí | sí | sí | PASS | PENDING_VALIDATION | no | no | línea HE + base CC | convenio aplicable |
| 3b | Seguro médico flexible | Payroll · Beneficios | sí | sí | sí | sí | parcial | PASS | PENDING_VALIDATION | no | sí (tope 500/1500€) | línea RE en especie | Art. 42.3.c LIRPF |
| 3c | Stock options | Equity · Payroll | sí | sí | sí | parcial | sí (engine) | PARTIAL | PENDING_VALIDATION | no | sí | línea SO + acumulado 190 | si `requiresHumanReview` → bloquear oficial |
| 3d | PNR 1 día | Payroll · Incidencias | sí | sí | sí | sí | sí | PASS | PENDING_VALIDATION | no | no | descuento proporcional | — |
| 3e | IT por AT | Payroll · IT | sí | sí | sí | DRYRUN FDI/Delt@ | sí | PARTIAL | PENDING_VALIDATION | sí (Delt@/INSS) | no | FDI + Delt@ + payslip | 75% Mutua + complemento convenio |
...
| 8g | Informe fiscal 111/190 | Fiscal · Reporting | sí | sí | sí | DRYRUN AEAT | parcial | PARTIAL | PENDING_VALIDATION | sí (AEAT) | sí (clasificación SO) | acumulados + claves | — |
...
| 11 | Modelos 111/190 con SO y flex | Fiscal | parcial | sí | sí | DRYRUN | parcial | PARTIAL | PENDING_VALIDATION | sí (AEAT) | sí (SO) | acumulados + claves/subclaves | — |
...
| 14 | Recibo final imprimible | Payroll · Render | sí | sí | sí | render model + PDF | parcial | PARTIAL | PENDING_VALIDATION | no | no | totales coherentes + conceptos | objetivo PASS tras snapshot |
