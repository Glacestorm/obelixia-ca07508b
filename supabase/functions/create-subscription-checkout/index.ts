...
const TIER_PRICES: Record<string, string> = {
  'core': 'price_1SgGbv4BQ21V0AcNsCQtyHIW',
  'automation': 'price_1SgGc84BQ21V0AcNt1vodklJ',
  'industry': 'price_1SgGcI4BQ21V0AcNtxvqwd6B',
};
...
serve(async (req) => {
  ...
  try {
    ...
    if (!tier || !TIER_PRICES[tier]) {
      throw new Error(`Invalid tier: ${tier}. Valid tiers: core, automation, industry`);
    }
