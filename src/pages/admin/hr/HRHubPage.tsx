...
const modules: HRModuleCard[] = [
  ...
  },
  {
    ...
    phase: 'Fase I',
    available: true,
    badges: ['Art. 82-86 RIRPF', 'Mod. 111/190'],
  },
  {
    id: 'bank-accounts',
    title: 'Cuentas Bancarias',
    description: 'Multi-IBAN empleados, domiciliación de nóminas, SWIFT/BIC',
    icon: CreditCard,
    route: '/obelixia-admin/hr/bank-accounts',
    phase: 'Fase I',
    available: true,
    badges: ['Multi-IBAN', 'SEPA'],
  },
  {
    id: 'bridge',
