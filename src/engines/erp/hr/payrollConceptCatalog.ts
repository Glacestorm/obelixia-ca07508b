...
export const ES_CONCEPT_DEFINITIONS: ESConceptDefinition[] = [
  ...
  // S9.18-H4: Seguro médico — ambos tramos cotizan SS (LGSS Art. 147) e impactan CRA
  { code: 'ES_RETRIB_FLEX_SEGURO', name: 'Seguro médico empresa', concept_type: 'earning', subcategory: 'flexible_remuneration', is_salary: false, is_taxable: false, is_ss_contributable: true, impacts_cra: true, impacts_irpf: false, impacts_net_payment: false, calculation_type: 'fixed', default_sign: 'positive', is_percentage: false, is_prorrateado: false, sort_order: 70, legal_reference: 'LIRPF Art. 42.3.c — exento IRPF, cotiza SS (LGSS Art. 147)' },
  // S9.18-H4: Exceso seguro médico — taxable + contributable + CRA
  ...
  // S9.20: Exceso ticket restaurante — taxable + cotiza SS + IRPF + CRA
  { code: 'ES_RETRIB_FLEX_RESTAURANTE_EXCESO', name: 'Ticket restaurante (exceso gravado)', concept_type: 'earning', subcategory: 'flexible_remuneration', is_salary: false, is_taxable: true, is_ss_contributable: true, impacts_cra: true, impacts_irpf: true, impacts_net_payment: false, calculation_type: 'fixed', default_sign: 'positive', is_percentage: false, is_prorrateado: false, sort_order: 73, legal_reference: 'RIRPF Art. 45.2 — exceso sobre 11€/día, sujeto IRPF + cotiza SS' },
