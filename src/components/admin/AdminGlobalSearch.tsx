...
const searchItems: SearchItem[] = [
  ...
  { id: 'ai-agents-specific', label: 'IA Center', description: 'Centro de mando unificado de agentes IA', panel: 'erp', path: '/obelixia-admin/erp', icon: Bot, keywords: ['agentes', 'ia', 'ai', 'autonomo', 'copilot', 'voz', 'center', 'command'] },
