/**
 * RegulatoryFeedbackSheet - Human feedback panel for regulatory documents
 * Allows reviewing AI-generated summaries, impact, and classification
 */
...
import {
  ...
  AlertTriangle, Shield, Scale, Users, Building2
} from 'lucide-react';
...
const REVIEWABLE_FIELDS = [
  { key: 'summary', label: 'Resumen', description: 'Calidad del resumen ejecutivo generado' },
  { key: 'impact_level', label: 'Nivel de impacto', description: 'Severidad asignada (critical/high/medium/low)' },
  { key: 'impact_domains', label: 'Dominios impactados', description: 'Áreas afectadas (RRHH, Legal, Compliance, Fiscal)' },
  { key: 'impact_summary', label: 'Resumen de impacto', description: 'Descripción del impacto operativo' },
  { key: 'classification', label: 'Clasificación', description: 'Tipo documental, ámbito territorial, área legal' },
] as const;
...
export function RegulatoryFeedbackSheet({ open, onOpenChange, document }: RegulatoryFeedbackSheetProps) {
  const { feedbacks, stats, loading, fetchFeedback, submitFeedback } = useRegulatoryFeedback();
                  ...
                  <Card key={field.key} className={cn(
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex-1" onClick={() => setSelectedField(isSelected ? null : field.key)}>
                      ...
                      {/* Previous feedback for this field */}
