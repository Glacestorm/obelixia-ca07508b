 ...
 * Menú moderno con categorías colapsables para el módulo Academia
 */
...
export const academiaNavCategories: AcademiaNavCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'gamification-dashboard', label: 'Dashboard Gamificación', shortLabel: 'Gamif.', icon: <Trophy className="h-4 w-4" />, badge: 'Nuevo' },
...
export const AcademiaNavigationDesktop = memo(function AcademiaNavigationDesktop({
  activeTab,
  onTabChange
}: AcademiaNavigationProps) {
  return (
...
export const AcademiaNavigationMobile = memo(function AcademiaNavigationMobile({
  activeTab,
  onTabChange
}: AcademiaNavigationProps) {
