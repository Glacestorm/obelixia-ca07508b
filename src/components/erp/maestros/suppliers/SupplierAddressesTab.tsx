/**
 * Tab de Direcciones del Proveedor
 */
...
interface SupplierAddressesTabProps {
  supplierId: string;
...
export const SupplierAddressesTab: React.FC<SupplierAddressesTabProps> = ({
  supplierId,
  addresses,
  onRefresh
}) => {
  ...
  const handleAddAddress = async () => {
    ...
    try {
      const { error } = await supabase
        ...
        .insert([{ supplier_id: supplierId, ...newAddress }] as any);
...
export default SupplierAddressesTab;
