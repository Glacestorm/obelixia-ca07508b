...
const STATUS_LABELS: Record<string, string> = {
  ...
  'mobility:draft': 'Borrador',
  'mobility:planned': 'Planificada',
  'mobility:pre_assignment': 'Pre-asignación',
  'mobility:active': 'Activa',
  'mobility:extending': 'Extensión',
  'mobility:repatriating': 'Repatriación',
  'mobility:transition': 'En transición',
  'mobility:completed': 'Finalizada',
  'mobility:cancelled': 'Cancelada',
