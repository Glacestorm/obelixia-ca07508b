/**
 * RegistrationClosureSection — Compact operational closure UI
 * V2-ES.5 Paso 4: Shows closure status, blockers, and action button
 *
 * Integrates into RegistrationDataPanel without new routes.
 */
...
import type { ClosureBlocker, ClosureReadinessResult, ClosureSnapshot } from './registrationClosureEngine';

interface Props {
  /** From useRegistrationClosure */
  canClose: boolean;
  isClosed: boolean;
  isConfirmed: boolean;
  ...
  if (isConfirmed) {
    return (
      <div className={cn('flex items-center gap-1.5 text-[10px] text-emerald-600', className)}>
        ...
        <span>Proceso confirmado oficialmente — cierre implícito</span>
      </div>
    );
  }
      ...
      <div className={cn('space-y-1.5', className)}>
        <div className="flex items-center justify-between">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Reabrir proceso de alta</AlertDialogTitle>
                <AlertDialogDescription>
      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          ...
          >
            ...
            Cerrar alta internamente
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Cerrar proceso de alta internamente</AlertDialogTitle>
            <AlertDialogDescription>
              El proceso quedará marcado como cerrado internamente con una evidencia inmutable.
              Esto <strong>no</strong> implica confirmación oficial ante TGSS/Sistema RED.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <Textarea
