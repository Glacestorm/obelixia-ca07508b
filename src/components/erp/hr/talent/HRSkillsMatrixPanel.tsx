    ...
    const fetchEmployees = async () => {
      ...
      try {
        const { data, error } = await (supabase
          ...
          .select('id, first_name, last_name, base_salary, erp_hr_departments!erp_hr_employees_department_id_fkey(name), erp_hr_positions!erp_hr_employees_position_id_fkey(name)') as any)
