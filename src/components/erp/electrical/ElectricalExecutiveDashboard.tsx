/**
 * ElectricalExecutiveDashboard - Multi-company executive reporting with PDF/Excel export
 */
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Badge variant="secondary" className="text-xs">{kpis.companyBreakdown.length} empresas</Badge>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
        {[
          ...
          { icon: BarChart3, label: 'Conversión', value: `${kpis.conversionRate}%`, color: 'text-blue-500', bg: 'bg-blue-500/10' },
          { icon: Clock, label: 'T. medio cierre', value: `${kpis.avgCloseTimeDays}d`, color: 'text-orange-500', bg: 'bg-orange-500/10' },
          { icon: TrendingDown, label: 'Ahorro est.', value: `${fmtK(kpis.totalEstimatedSavings)}€`, color: 'text-emerald-600', bg: 'bg-emerald-500/10' },
          { icon: TrendingDown, label: 'Ahorro valid.', value: `${fmtK(kpis.totalValidatedSavings)}€`, color: 'text-green-600', bg: 'bg-green-500/10' },
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-muted-foreground text-xs">
                    ...
                    <th className="text-right p-2">Expedientes</th>
                    <th className="text-right p-2">Cerrados</th>
                    <th className="text-right p-2">Tasa cierre</th>
                    <th className="text-right p-2">Ahorro estimado</th>
                  </tr>
                </thead>
                <tbody>
