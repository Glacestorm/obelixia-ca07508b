...
export { GaliaWorkflowManager } from './GaliaWorkflowManager';
export { GaliaAlertsList } from './GaliaAlertsList';
export { GaliaTecnicosPanel } from './GaliaTecnicosPanel';
export { GaliaResumenTab } from './GaliaResumenTab';
export { GaliaExpedientesTab } from './GaliaExpedientesTab';
